...
class Component extends Model
{
     ...
     */
    public $table = 'mostafamahmoud_wedo_components_';
    ...
    /* Defining the relation between the Icon Image and the Components component */
    public $attachOne = [
        'wedoimg' => 'System\Models\File'
    ];

    public $belongsToMany = [
        'wedo' => [
            /* define the model that links is related to */
            'MostafaMahmoud\Wedo\Models\Wedo',
